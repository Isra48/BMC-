        ...
        return <React.Fragment> 
          ...
          <nav className="navbar navbar-expand-lg navbar-light navbar-p">
            <div className="container-fluid">
              <a className="navbar-brand" href="https://wortev.com/" target="_blank">
                  ...
                  <div className="nav-item dropdown">
                    <a className="nav-link flex" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <div className="profile-pic">
                        <img src={this.props.formValues.photo} alt=""/>
                      </div>
                    </a>
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><Link style={{fontSize: '12pt'}} className="dropdown-item" to="/confirm">Perfil</Link></li>
                      <li><a style={{fontSize: '12pt'}} className="dropdown-item" href="#" onClick={this.Salir}>Salir</a></li>
                      </ul>
                  </div>
                </div>
              </div>
