          ...
          <div className="blackfootercontainer">
            <div className="containlogo-text">
              ...
              <p className="blacktext">
                ...
                <br /> <br />
                Con nuestra plataforma para el crecimiento de empresas, PyMes y
                startups, se genera un modelo de negocio de valor que va
            ...
            <div className="wortevsnblack">
              ...
              <div className="iconossnblack">
                <a href="https://www.facebook.com/wortev">
                  <img className="fblogo" src={fblogo} alt="Logo de facebook" />{" "}
                </a>
