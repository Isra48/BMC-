...
class Grid extends React.Component {
    ...
    componentDidMount(){
        ...
        } else if (now - setupTime > hours*1000*60*60) {
            localStorage.clear();
            window.location="/";
        }
    }
    ...
    selectModal = (index) =>{
        switch (index){
            case 0:
                this.setState({currentlyModified: 0, currentName: "Socios clave", currentInfo: "Define a tus proveedores y aliados para producir y entregar tu producto o servicio.", showModal: true})
            break
            case 1:
                this.setState({currentlyModified: 1, currentName: "Actividades calve", currentInfo: "Traza las tareas esenciales de tu proceso, desde los insumos hasta la comercialización.", showModal: true})
            break
            case 2:
                this.setState({currentlyModified: 2, currentName: "Canales", currentInfo: "Cómo darás a conocer y entregarás tu producto o servicio.", showModal: true})
            break
            case 3:
                this.setState({currentlyModified: 3, currentName: "Recursos clave   ", currentInfo: "Describe los elementos indispensables para que funcione tu negocio.", showModal: true})
            break
            case 4:
                this.setState({currentlyModified: 4, currentName: "Segmento de clientes", currentInfo: "Describe los hábitos y características del cliente al que le vas a vender.", showModal: true})
            break
            case 5:
                this.setState({currentlyModified: 5, currentName: "Relaciones con el cliente", currentInfo: "Define cómo será tu comunicación e interacción con ellos.", showModal: true})
            break
            case 6:
                this.setState({currentlyModified: 6, currentName: "Propuestas de valor", currentInfo: "Escribe por qué los clientes te preferirían a ti.", showModal: true})
            break
            case 7:
                this.setState({currentlyModified: 7, currentName: "Estructura de costos", currentInfo: "Enlista todos los gastos que harás para que tu negocio funcione.", showModal: true})
            break
            case 8:
                this.setState({currentlyModified: 8, currentName: "Fuente de ingresos", currentInfo: "Explica las formas en que obtendrás ingresos.", showModal: true})
            break
            default:
                this.setState({currentlyModified: null, currentName: '', showModal: false})
            break
        }
    }
    ...
    // outHover = () =>{
    //     this.setState({title: this.state.preTitle})
    //     this.setState({preTitle: })
    // }
    ...
    handleClick = e => {
        ...
        if(this.state.editing === true){
            ...
            this.setState({text: '', editing: false, showModal:false});
        }
        else{
            switch (this.state.currentlyModified){
                case 0:
    ...
    handleClose = (e) => {
        this.setState({showModal: false, currentInfo: "", currentName:"", text:""});
    }
    ...
    render(){
        ...
        return  <React.Fragment>
            <div className="main-grid">
                <div className={this.state.preTitle}>
                ...
                <div className="guardar-bcm">
                    <button onClick={this.state.editingBMC ? this.handleUpdate : this.handleSave} className="btn-guardar-bcm">{this.state.editingBMC ? "ACTUALIZAR" : "CREAR"}</button>
                </div>
                <div className="grid">
                    <div className="grid-item" style={{maxHeight:'120vh'}} onClick={(e)=>{this.selectModal(0)}} data-bs-toggle="modal" data-bs-target="#addModal">
                    ...
                    <div className="grid-item" onClick={(e)=>{this.selectModal(1)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                    ...
                    <div className="grid-item" style={{maxHeight:'120vh'}} onClick={(e)=>{this.selectModal(3)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                    ...
                    <div className="grid-item"  style={{maxHeight:'120vh'}}  onClick={(e)=>{this.selectModal(6)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                    ...
                    <div className="grid-item" onClick={(e)=>{this.selectModal(5)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                            <span>4 . Relacion con el cliente</span>
                            <div className="header-grid-img">
                    ...
                    <div className="grid-item" onClick={(e)=>{this.selectModal(2)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                            <span>3. Canales de distribucion</span>
                            <div className="header-grid-img">
                    ...
                    <div className="grid-item" style={{maxHeight:'120vh'}} onClick={(e)=>{this.selectModal(4)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                            <span>1. Segmento de clientes</span>
                            <div className="header-grid-img">
                    ...
                    <div className="grid-item" onClick={(e)=>{this.selectModal(7)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                            <span>9. Estructura de costos</span>
                            <div className="header-grid-img">
                    ...
                    <div className="grid-item" onClick={(e)=>{this.selectModal(8)}} data-bs-toggle="modal" data-bs-target="#addModal">
                        <div className="header-grid">
                            <span>5. Fuente de ingresos</span>
                            <div className="header-grid-img">
