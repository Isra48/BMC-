...
class SideBar extends React.Component {
  ...
  render(){
      return <React.Fragment>
        ...
        <div onMouseEnter={this.handleClick} onMouseLeave={this.handleClick} className="sidebar" ref={this.sidebar}>
          <div style={{cursor: 'pointer'}} onClick={this.props.onClickBmc} className="sidebar-title">
            <img className="logo-side" src={logo} alt=""/>
            ...
            <button onClick={this.handleClick} className="btn-p d-lg-none"><img ref={this.image} src={minimize} alt=""/></button>
        </div>
